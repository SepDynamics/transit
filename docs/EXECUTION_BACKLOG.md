...
## P0: Prove Value On MBTA

### 1. Build replayable MBTA case packs
...
## P1: Strengthen The MBTA Replay Lane
...
- keep the combined MBTA case-pack suite green before each cluster deletion pass
